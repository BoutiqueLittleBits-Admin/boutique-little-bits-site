      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="mb-5 inline-flex flex-col items-center leading-none text-white">
              <span className="block whitespace-nowrap font-logo text-5xl leading-[0.72]">Litt<span className="inline-block origin-bottom scale-y-[0.86]">l</span>e Bits</span>
              <span className="mt-1 block pl-[0.78em] text-[10px] font-bold uppercase tracking-[0.78em] text-white/70">Boutique</span>
            </div>
