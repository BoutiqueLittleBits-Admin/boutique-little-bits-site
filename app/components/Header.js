        ...
        <div className="flex flex-shrink-0 items-center justify-end gap-2 md:gap-3">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 top-full pt-2 w-80 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="overflow-hidden rounded-[1.25rem] border border-brand-lavender bg-[#fffdfb] shadow-boutique">
                ...
                {!isLoaded ? (
                  ...
                  <div className="bg-[#fffdfb] p-6 text-center">
                  ...
                  <>
                    <div className="max-h-64 overflow-y-auto">
                      {cart.slice(0, 3).map((item, index) => (
                        <div key={item.cartKey || item.slug || index} className="flex items-center gap-3 p-4 border-b border-brand-lavender bg-[#fffdfb] last:border-b-0">
